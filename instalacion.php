...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="cuerpo">
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-truck"></i> Procesos de Instalación
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                             <div class="panel-heading">Procesos
                                 ...
                                 <!--<button type="button" class="btn btn-default" onclick="window.open('ReportePreparacion.php?tipo=4','_blank')"><span class='fa fa-print'></span></button>-->
                                 <button type="button" class="btn btn-warning" onclick="Activas()"><span class='fa fa-dashboard'></span></button>
                                 <button type="button" class="btn btn-default" onclick="window.open('reportes/impresion/ReporteInstalacion.php?tipo=4','_blank')"><span class='fa fa-print'></span></button>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" aria-describedby="dataTables-example_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th  style="width: 470px;">DESCRIPCIÓN</th>--> 
                                            <th  style="width: 100px;">OPERADOR</th>
                                            <th style="width:120px;"></th>
                                        </tr>
                                    </thead>
                                  <tbody id="PendientesInstalacion">
    ...
    <div class="modal fade" id="modalpinstalacion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title" id="myModalLabel">INSTALACIÓN</h4>
                </div>
                <div class="modal-body">
                   <div class="panel panel-default">
                        <div class="panel-heading">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <form id="forminstalacion">
                                    <input type='hidden' name="instalacionidproduccion" id="instalacionidproduccion">
                                    <input type='hidden' name="instalacionid" id="instalacionid">
                                    <input type='hidden' name="instalacionemp" id="instalacionemp">
                                    <input type='hidden' name="instalaciondepartamento" id="instalaciondepartamento">
                                    <table class="table">
                                        
                                        <tbody>
                                            <tr>
                                                <td>COLABORADORES INSTALACION</td>
                                            </tr>
                                            <tr>
                                                <td><input type="text" name="colaboradoresinstalacion" id="colaboradoresinstalacion" class="form-control"></td>
                                            </tr>        
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" onclick="eliminarInstalacion()">ELIMINAR</button>
                    <button type="button" class="btn btn-primary" onclick="guardaInstalacion()">GUARDAR</button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">CERRAR</button>
                </div>
            </div>
            <!-- /.modal-content -->
    ...
    <script src="js/complemento.js"></script>
     ...
     <script src="js/Modulos/Instalacion/scripts.js"></script>
