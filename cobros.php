...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="cuerpo">
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><span style='color:#0B0'><i class="fa fa-money"></i></span> Administrador de Cobros
                        ...
                        <div class="panel panel-default">
                            <!--<div class="panel-heading">
                                ...
                                <div class="btn-group pull-right">
                                   <button type="button" class="btn btn-default" onclick="window.open('ReporteRemision.php','_blank')" title="Reporte Remisión"><i class='fa fa-print'></i></button>
                                   <button type="button" class="btn btn-info" onclick="pay()" >PAGADO</button>
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-sm-2">
                                               <div id="dataTables-example_filter" class="dataTables_filter">
                                                   <label>Desde<input type="date" name="desde" id="desde" class="form-control input-sm " aria-controls="dataTables-example" value="<?php echo date("Y-m-")."01" ?>"></label>
                                               </div>
                                           </div>
                                           <div class="col-sm-2">
                                               <div id="dataTables-example_filter" class="dataTables_filter">
                                                   <label>Hasta<input type="date" name="hasta" id="hasta" class="form-control input-sm " aria-controls="dataTables-example"  value="<?php echo date("Y-m-d") ?>"></label>
                                               </div>
                                           </div>

                                           <div class="col-sm-2">
                                               <div id="dataTables-example_filter" class="dataTables_filter">
                                                   <label>Folio<input type="text" name="folio" id="folio" class="form-control input-sm " ></label>
                                               </div>
                                           </div>
                                           <div class="col-sm-2">
                                               <div id="dataTables-example_filter" class="dataTables_filter">
                                                   <label>Cliente<input type="text" name="cliente" id="cliente" class="form-control input-sm "></label>
                                               </div>
                                           </div>
                                           <div class="col-sm-2">
                                               <div id="dataTables-example_filter" class="dataTables_filter">
    ...
    <script src="js/Modulos/Cobros/scripts.js" language="javascript"></script>
