...
if($_POST['accion'] == "index")
{
   ...
   $campos_borrador = array("ID",
    ...
    $condicionalesx = " AND AGENDA.IDDEPARTAMENTO=".$_POST['departamento']." and EMPRESA=3 AND (FECHA='".$_POST['dia']."' OR GUARDADO=1)";
    $condicionalesx2 = " AND AGENDA.IDDEPARTAMENTO=".$_POST['departamento']." and EMPRESA=2 AND (FECHA='".$_POST['dia']."' OR GUARDADO=1)";
    $condicionalesxborrador = " AND AGENDA.IDDEPARTAMENTO=".$_POST['departamento']." and GUARDADO=1";
    ...
    $jsonxborrador  = $conection->select_table($campos_borrador, "AGENDA", $joinx, $condicionalesxborrador, array(), 0);
    ...
    {
        $json3[$contador1]['DOCTOS_VE.FOLIO'] = (intval(substr($json3[$contador1]['DOCTOS_VE.FOLIO'],1)));
   ...
   for($i = 0; $i < count($json4); $i++)
   {
    ...
    $obj = (object) array("OPERADORES"=>$json, "TAREAS"=>$json4, "BORRADOR"=> $jsonxborrador);
...
if($_POST['accion'] == "show_tarea")
{
    ...
    $condicionales = " and ID=".$_POST['registro'];
    $json2 = $conection->select_table_advanced($campos, "AGENDA", array(), $condicionales, array(), 0);
...
if($_POST['accion'] == "iniciadas")
{
    ...
    $condicionales = " and agenda.guardado=0 ";
    if($_POST['dia']!="")
    {
...
if($_POST[0] == "guardaDB")
{
    ...
    $id = " AGENDA.FECHA='".$_POST[1]."' and AGENDA.IDDEPARTAMENTO=".$_POST[2]." and guardado=0";
    ...
    foreach($_POST  as $key => $value)
    {
        if($key>2)
        {
           ...
           $valores = array($_POST[$key]['empresa'],$_POST[$key]['docto_ve_id'], $_POST[$key]['docto_ve_det_id'], $_POST[$key]['hour'], $_POST[$key]['minute'], $_POST[$key]['hour1'], $_POST[$key]['minute1'], $_POST[$key]['operador'], $_POST[2], $_POST[$key]['general'], "'".$_POST[$key]['folio']."'", "'".utf8_decode($_POST[$key]['cliente'])."'", "'".utf8_decode($_POST[$key]['descripcion'])."'", "'".$_POST[$key]['entrega']."'", "'background-color:".$_POST[$key]['color']."'", "'".$_POST[1]."'", "'".utf8_decode($_POST[$key]['observacion'])."'", "'".$_POST[$key]['estatus']."'");
...
if($_POST['accion'] == "guardaBorrador")
{
    $conection1 = new conexion_nexos(1);

    $campos2 = array("ID");
    $join2 = array();
    $condicionales = " AND AGENDA.DOCTO_VE_ID=".$_POST['docto_ve_id']." and AGENDA.FECHA='".$_POST['fecha']."' AND AGENDA.DOCTO_VE_DET_ID=".$_POST['docto_ve_det_id'];

    $json1 = $conection1->select_table_advanced($campos2, "AGENDA", $join2, $condicionales, array(), 0);
    ...
    if(count($json1) == 0)
    {
        $campos = array("empresa",
                        ...
                        "operador",
                        "arreglo");
        $valores = array($_POST['empresa'],
                         $_POST['docto_ve_id'],
                         $_POST['docto_ve_det_id'],
                         $_POST['departamento'],
                         "'".$_POST['fecha']."'",
                         $_POST['folio'],
                         "'".$_POST['cliente']."'",
                         ...
                         0,
                         0);
        $json = $conection1->insert_table($campos, "AGENDA", $valores);
    }

    $campos2 = array("ID");
    $join2 = array();
    $condicionales = " AND AGENDA.DOCTO_VE_ID=".$_POST['docto_ve_id']." AND AGENDA.DOCTO_VE_DET_ID=".$_POST['docto_ve_det_id']." and AGENDA.EMPRESA=".$_POST['empresa']." and AGENDA.OPERADOR='".$_POST['idOperador']."' AND AGENDA.FECHA='".$_POST['fecha']."'";

    $json1 = $conection1->select_table_advanced($campos2, "AGENDA", $join2, $condicionales, array(), 0);

    if(count($json1) > 0)
    {
        $id = " AGENDA.DOCTO_VE_ID=".$_POST['docto_ve_id']." AND AGENDA.DOCTO_VE_DET_ID=".$_POST['docto_ve_det_id']." and AGENDA.EMPRESA=".$_POST['empresa']." and AGENDA.OPERADOR=".$_POST['idOperador']." AND AGENDA.FECHA='".$_POST['fecha']."'";
        //$conection1->delete_of_table("AGENDA", $condicional, array());
        $campos = array("guardado",
                        "operador",
                        "arreglo");
        $valores = array(1,
                        0,
                        0);
        $conection1->update_table($campos, "AGENDA", $valores, $id);
...
if($_POST['accion'] == "lista_borrador")
{
    $conection1 = new conexion_nexos(1);
    $condicionalesxborrador = " AND AGENDA.IDDEPARTAMENTO=".$_POST['departamento']." and GUARDADO=1";
    $campos_borrador = array("DOCTO_VE_ID",
                            "DOCTO_VE_DET_ID",
                            "FOLIO",
                            "CLIENTE",
                            "DESCRIPCION",
    ...
    $jsonxborrador  = $conection1->select_table($campos_borrador, "AGENDA", array(), $condicionalesxborrador, array(), 0);
    $obj = (object) $jsonxborrador;
    echo json_encode($obj);
    $conection1 = null;
}

if($_POST['accion'] == "guardaBorradorExtra")
{
    $conection1 = new conexion_nexos(1);

    $campos2 = array("ID");
    $join2 = array();
    $condicionales = " AND AGENDA.FECHA='".$_POST['fecha']."' AND AGENDA.operador='".$_POST['idOperador']."' AND AGENDA.folio='".$_POST['folio']."' AND AGENDA.DESCRIPCION='".$_POST['descripcion']."'";
    ...
    {
        $id = " AGENDA.FECHA='".$_POST['fecha']."' AND AGENDA.operador=".$_POST['idOperador']." AND AGENDA.folio='".$_POST['folio']."' AND AGENDA.DESCRIPCION='".$_POST['descripcion']."'";
        $campos = array("guardado",
                        "operador",
                        "arreglo");
        $valores = array(1,
...
if($_POST['accion'] == "eliminar_borrador")
{
    $conection1 = new conexion_nexos(1);
    $conection1->delete_of_table("AGENDA", " AGENDA.ID=".$_POST['registro'], array());
