...
session_start();
	...
	if($_POST["accion"] == "save")
	{
		...
		$valores = array("'".utf8_decode($_POST['cliente'])."'", "'".utf8_decode($_POST['descripcion'])."'", "'".$_POST['fechaCotizacion']."'", "'".utf8_decode($_POST['operador'])."'", "'".utf8_decode($_POST['solicitante'])."'", $_POST['estatus']);
        ...
        if($_POST['email'] != "")
        {
            ...
            $texto = "<table>";
            $texto .= "<tr><td>CLIENTE: </td><td>".utf8_decode($_POST['cliente'])."</td></tr>";
            $texto .= "<tr><td>SOLICITANTE: </td><td>".$_POST['solicitante']."</td></tr>";
            $texto .= "<tr><td>DESCRIPCION: </td><td>".utf8_decode($_POST['descripcion'])."</td></tr>";
