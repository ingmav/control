<?php
	...
	if($_POST["accion"] == "index")
	{
		...
		{
			$realizado_gf = 1;
			$filtro1 = "AND PRODUCCION.IDESTATUS =2";
			if($_POST['fecha']!="")
			{
				$filtro1.="  AND PRODUCCION.FECHA between '".$_POST['fecha']." 00:00:00' and '".$_POST['fecha']." 23:59:59'";
			}else
			{
				$filtro1.="  AND PRODUCCION.FECHA between '".date("d.m.Y")." 00:00:00 and '".date("d.m.Y")." 23:59:59'";
			}
		}else
		{
			$realizado_gf = 0;
			$filtro_general1 = "AND PRODUCCION.IDESTATUS !=2";	
		}
		...
		{
			$realizado_pv = 1;
			$filtro2 = "AND PRODUCCIONPV.IMPRESION_GF =2";
			if($_POST['fecha']!="")
			{
				$filtro2.="  AND PRODUCCIONPV.F_IMPRESION_GF between '".$_POST['fecha']." 00:00:00' and '".$_POST['fecha']." 23:59:59'";
			}else
			{
				$filtro2.="  AND PRODUCCIONPV.F_IMPRESION_GF='".date("d.m.Y")." 00:00:00' and '".date("d.m.Y")." 23:59:59'";
			}
		}else
		{
			$realizado_pv = 0;
			$filtro_general2 = "AND PRODUCCIONPV.IMPRESION_GF !=2";	
		}
        ...
        AND (PRODUCCIONPV.GF_DISENO=0 OR PRODUCCIONPV.DISENO_GF=2) ".$filtro_general2." ".$filtro2;
