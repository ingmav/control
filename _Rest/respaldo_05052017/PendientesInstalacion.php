<?php
	...
	if($_POST["accion"] == "index")
	{
        ...
        AND (TABLEROPRODUCCION.GF_PREPARACION=0 OR TABLEROPRODUCCION.PREPARACION_GF=2)
        ";
		...
		while ($row = ibase_fetch_object ($result, IBASE_TEXT)){
			...
			$json[$indice]['FOLIO'] 			= "NX".$row->TIPO_DOCTO."-".(int)$row->FOLIO;
			...
			$json2 = $conection1->select_table($campos2, "DOCTOS_VE_DET", $join2, $condicionales2, $order2, 0);
