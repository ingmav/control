<?php
	...
	if($_POST["accion"] == "save")
	{
		...
		$valores = array("'".$_POST['foliorequisicion']."'", "'".$_POST['empresa']."'", "'".$_POST['tipo_documento']."'", "'".$_POST['fechaSolicitud']."'", "'".utf8_decode($_POST['cliente'])."'", $_POST['estatus'], $_SESSION['IDUSUARIO'], "'".$_POST['observacion']."'", "'".$_POST['forma_pago']."'");
