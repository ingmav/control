...
if($_POST["accion"] == "index")
{
    ...
    $condicionales2 = " DOCTOS_PV_DET.CLAVE_ARTICULO IN ('PRO03', 'CN11', 'CN12', 'CN13','CN17', 'MSD06') AND DOCTOS_PV.TIPO_DOCTO='V' AND DOCTOS_PV.ESTATUS!='C'".$fecha2;
    ...
    $condicionales2 = "  ((LINEAS_ARTICULOS.LINEA_ARTICULO_ID='3516' AND DOCTOS_PV_DET.CLAVE_ARTICULO LIKE 'TL%') OR DOCTOS_PV_DET.CLAVE_ARTICULO in ('PRO04', 'MSG01'))  AND DOCTOS_PV.TIPO_DOCTO='V' AND DOCTOS_PV.ESTATUS='N'".$fecha2;
    ...
    $condicionales4 = " ((LINEAS_ARTICULOS.LINEA_ARTICULO_ID='2156' AND DOCTOS_PV_DET.CLAVE_ARTICULO LIKE 'TL%') OR DOCTOS_PV_DET.CLAVE_ARTICULO in ('PRO04', 'MSG01')) AND DOCTOS_PV_DET.CLAVE_ARTICULO LIKE 'TL%' AND DOCTOS_PV.TIPO_DOCTO='V' AND DOCTOS_PV.ESTATUS='N'".$fecha2;
    ...
    $condicionales2 = " LINEAS_ARTICULOS.LINEA_ARTICULO_ID NOT IN ('3516',1265,'1849','2184','1317','2616','6347', '2048','2069','7159','1954', '17397')  AND DOCTOS_PV.TIPO_DOCTO='V' AND DOCTOS_PV.ESTATUS='N'".$fecha2;
    ...
    $condicionales4 = " LINEAS_ARTICULOS.LINEA_ARTICULO_ID NOT IN ('2156','2139','2146','2152','2143','2160','2152','2140','2145','2150','2147', '2149', '17397') AND DOCTOS_PV.TIPO_DOCTO='V' AND DOCTOS_PV.ESTATUS='N'".$fecha2;
