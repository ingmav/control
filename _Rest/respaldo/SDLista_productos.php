	...
	if($_POST["accion"] == "save")
	{
		...
		while($contador > $count)
		{
			...
			if($existe->PAGINADOR > 0)
			{
				...
				$valores = array(1, $diseno, $impresion, $preparacion, $instalacion, $entrega, $maquilas, 1, "'".$nota."'");
			...
			}else
			{
				...
				$valores = array($_POST['DOCTO_VE_ID'],$_POST['procesos'][$count],1, $diseno, $impresion, $entrega, $maquilas, $instalacion, 1, "'".$nota."'", "'".date("Y-m-d H:i:s")."'", $preparacion, "'".$fecha_entrega." ".$hora_entrega."'");
