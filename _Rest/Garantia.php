<?php
	...
	if($_POST["accion"] == "save")
	{
		...
		$valores = array("'".$_POST['foliogarantia']."'", "'".strtoupper(utf8_decode($_POST['material']))."'", "'".$_POST['cantidad']."'", "'".$_POST['medida']."'", "'".strtoupper(utf8_decode($_POST['cliente']))."'", $_SESSION['IDUSUARIO'], "'".strtoupper(utf8_decode($_POST['motivo']))."'", "'".$_POST['monto']."'");
	...
	if($_POST["accion"] == "update")
	{
        ...
        $valores = array("'".$_POST['foliogarantia']."'", "'".strtoupper(utf8_decode($_POST['material']))."'", "'".$_POST['cantidad']."'", "'".$_POST['medida']."'", "'".strtoupper(utf8_decode($_POST['cliente']))."'", "'".strtoupper(utf8_decode($_POST['motivo']))."'", "'".$_POST['monto']."'");
		$id = "ID = ".$_POST['id'];
