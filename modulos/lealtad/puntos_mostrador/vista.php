...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="cuerpo">
        	<div id="page-wrapper">
            	<div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-id-card-o" style="color: #E21800"></i> Puntos Nexprint Mostrador</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="hidden" name="descuento_total" id="descuento_total">
                                </div>
                            </div>
                                <div class="table-responsive">
                                    ...
                                    <table id="tabla_desglose_ventas" class="informacion table table-striped table-bordered table-hover dataTable no-footer">
                                        <tr>
                                            ...
                                            <th style="width: 10%">Puntos Aplicables</th>
    ...
    <div class="modal fade" id="sumar_puntos"  tabindex="-1" role="dialog" aria-labelledby="modalCatalogoLabel" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-dialog">
            <div class="modal-content modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <div class="modal-body">
                        <div class="panel panel-default">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <label>Puntos Disponibles</label>
                                    <label id='puntos_empresa' style="color: Red"></label>
                                </div>
                            </div>
                                <div class="table-responsive">
                                    <div align="center" class="cargando">
                                    ...
                                    <table id="tabla_desglose_ventas" class="informacion table table-striped table-bordered table-hover dataTable no-footer">
                                        <tr>
                                            ...
                                            <th style="width: 10%">Monto Total</th>
                                            <th style="width: 15%">Suma de Puntos</th>
                                            <th style="width: 10%"></th>
                                        </tr>
                                        <tbody id="data_ventas"></tbody>
                                    </table>
    ...
    <script src="../../../modulos/lealtad/puntos_mostrador  /modelo.js"></script>
