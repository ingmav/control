...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="cuerpo">
        	<div id="page-wrapper">
            	<div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-users"></i> Nomina</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
            	<div class="row">
                                 ...
                                 <div class="row">
                                        <div class="col-lg-9">
                                             <div class="btn-group pull-right">
                                                <select id="filtro_quincena" class="form-control"></select>
                                             </div>
                                            
                                        </div>
                                        <div class="col-lg-3">
                                             <div class="btn-group pull-right">
                                                <button type="button" class="btn btn-primary" onclick="$('#rel_clientes').modal('show');">Agregar</button>
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" aria-describedby="dataTables-example_info">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style="width: 120px;">(PERC./DEDUC)</th>
                                                    <th style="width: 120px;">SALARIO FINAL</th>
    ...
    <script src="../../modulos/nomina/modelo.js"></script>
