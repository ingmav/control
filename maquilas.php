...
<?php
 if(isset($_SESSION['MAQUILAS']) and ($_SESSION['MAQUILAS'] == 1  OR $_SESSION['MAQUILAS'] == 2) )
 {
?>
<body>
    ...
    <div id="wrapper">
        ...
        <div class="cuerpo">
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class='fa fa-file-image-o'></i> Procesos de Maquilas
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                             <div class="panel-heading">Procesos
                                 ...
                                 <button type="button" class="btn btn-default" onclick="window.open('reportes/impresion/ReporteMaquilas.php?tipo=8','_blank')"><span class='fa fa-print'></span></button>
    ...
    <script src="js/complemento.js"></script>
     ...
     <script src="js/Modulos/Maquilas/scripts.js"></script>
