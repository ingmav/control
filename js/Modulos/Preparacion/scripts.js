...
function observaciones(obj, emp)
{
    ...
    if($(obj).parents("tr").data("empresa") != 3)
    {
        ...
        var variable = "accion=observaciones&EMPRESA="+empresa+"&id="+$(obj).parents("tr").data("id")+"&departamento=9";
...
function guardarTurnar()
{
    if(empresa!=3)
    {
        var variable = "accion=saveTurnar&empresa="+empresa+"&departamento=9&"+$("#formFinalizar").serialize();
...
function guardar()
{
    if(empresa!=3)
    {
        var variable = "accion=save&empresa="+empresa+"&departamento=9&"+$("#formFinalizar").serialize();
...
function cancelaActividad()
{
    ...
    if(empresa != 3)
    {
        var variable = "accion=cancelar&empresa="+empresa+"&departamento=9&"+$("#formCancelar").serialize();
        RestFullRequest("_Rest/General.php", variable, "actualizaDatagrid");
