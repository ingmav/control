...
function guardaInstalacion()
{
    ...
    RestFullRequest("_Rest/Pendientesinstalacion.php", variable, "actualizaDatagrid", 1);
}
...
function eliminarInstalacion()
{
    ...
    RestFullRequest("_Rest/Pendientesinstalacion.php", variable, "actualizaDatagrid", 2);
...
function observaciones(obj, emp)
{
    ...
    if($(obj).parents("tr").data("empresa") != 3)
    {
        ...
        var variable = "accion=observaciones&EMPRESA="+empresa+"&id="+$(obj).parents("tr").data("id")+"&departamento=4";
    ...
    }else
    {
        ...
        var variable = "accion=observaciones&id="+$(obj).parents("tr").data("fila")+"&departamento=4";
...
function guardarObservacion()
{
    ...
    {
        var variable = "accion=saveObservacion&"+$("#formObservaciones").serialize()+"&departamento=4";
...
function guardarTurnar()
{
    if(empresa!=3)
    {
        var variable = "accion=saveTurnar&empresa="+empresa+"&departamento=4&"+$("#formFinalizar").serialize();
        RestFullRequest("_Rest/General.php", variable, "actualizaDatagrid");
        $("#finalizaTarea").modal("hide");
    }else
    {
        var variable = "accion=saveTurnar&empresa="+2+"&"+$("#formFinalizar").serialize()+"&departamento=4";
        RestFullRequest("_Rest/PendientesPv.php", variable, "actualizaDatagrid", 1);
        $("#finalizaTarea").modal("hide");
    }
...
function guardar()
{
    if(empresa!=3)
    {
        var variable = "accion=save&empresa="+empresa+"&departamento=4&"+$("#formFinalizar").serialize();
        RestFullRequest("_Rest/General.php", variable, "actualizaDatagrid", 1);
    }else
    {
        var variable = "accion=save&empresa="+2+"&"+$("#formFinalizar").serialize()+"&departamento=4";
        RestFullRequest("_Rest/PendientesPv.php", variable, "actualizaDatagrid",1);
...
function cancelaActividad()
{
    ...
    if(empresa != 3)
    {
        var variable = "accion=cancelar&empresa="+empresa+"&departamento=4&"+$("#formCancelar").serialize();
        RestFullRequest("_Rest/General.php", variable, "actualizaDatagrid");
        $("#CancelarTarea").modal("hide");
    }else
    {

        var variable = "accion=cancelar&"+$("#formCancelar").serialize()+"&departamento=4";
