...
function observaciones(obj, emp)
{
	...
	$("#idtablero").val($(obj).parents("tr").data("id"));
        var variable = "accion=observaciones&EMPRESA="+empresa+"&id="+$(obj).parents("tr").data("id")+"&departamento=8";
...
{
	var variable = "accion=saveTurnar&empresa="+empresa+"&departamento=8&"+$("#formFinalizar").serialize();
...
function guardar()
{
	var variable = "accion=save&empresa="+empresa+"&departamento=8&"+$("#formFinalizar").serialize();
