...
function datagridPendientes(response)
{
    ...
    $.each(response, function(index, value)
    {
        ...
        campos += "<td>"+value['CLIENTESCALL.NOMBRE']+"<br>"+button+"</td>";
        campos += "<td>"+value['CLASIFICACIONCALL.DESCRIPCIONCLASIFICACION']+" /<br>"+value['SEGMENTOCALL.DESCRIPCIONSEGMENTO']+"</td>";
...
{
    window.open("reportes/reporte_call.php", "_black");
});
