...
function datagridPendientes(response)
{
	...
	$.each(response, function(index, value)
	{
		...
		if(value['NOMBREARTICULO'] != value['TABLEROPRODUCCION.NOTA'])
			texto_descripcion += "<u>"+value['NOMBREARTICULO']+"</u><BR>"+value['TABLEROPRODUCCION.NOTA'];
		else
			texto_descripcion += "<u>"+value['NOMBREARTICULO']+"</u>";
...
function guardar()
{
    ...
    RestFullRequest("_Rest/PendientesImpresion.php", variable, "verificarinventario", 1);
}
