...
function datagridPendientes(response)
{
	...
	$.each(response, function(index, value)
	{
		...
		campos += "<td style='text-align:justify'><b style='color:blue'>"+value['CLIENTES.NOMBRE']+"</b><b> ("+parseFloat(value['DOCTOS_VE_DET.UNIDADES']).toFixed(2)+" "+value['ARTICULOS.UNIDAD_VENTA']+")</b><br>"+texto_descripcion+"<br>"+instalacion+labelCancelacion+"</td>";
