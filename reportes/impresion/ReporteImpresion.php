...
$objPHPExcel->getProperties()->setCreator("MicrosipWeb") //Autor
    ...
    ->setTitle("Reporte Impresion")
    ->setSubject("Reporte Excel")
    ->setDescription("Reporte de Impresion")
    ->setKeywords("reporte de Impresion")
    ->setCategory("Reporte MicrosipWeb");

$tituloReporte = "Reporte Impresion";
...
header('Content-Disposition: attachment; filename="ReporteImpresion.xlsx"');
