...
$objPHPExcel->getProperties()->setCreator("MicrosipWeb") //Autor
    ...
    ->setTitle("Reporte Instalacion")
    ->setSubject("Reporte Excel")
    ->setDescription("Reporte de Instalacion")
    ->setKeywords("reporte de Instalacion")
    ->setCategory("Reporte MicrosipWeb");

$tituloReporte = "Reporte Instalacion";
...
header('Content-Disposition: attachment; filename="ReporteInstalacion.xlsx"');
