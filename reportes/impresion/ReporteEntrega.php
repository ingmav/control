...
$objPHPExcel->getProperties()->setCreator("MicrosipWeb") //Autor
    ...
    ->setTitle("Reporte Entrega")
    ->setSubject("Reporte Excel")
    ->setDescription("Reporte de Entrega")
    ->setKeywords("reporte de Entrega")
    ->setCategory("Reporte MicrosipWeb");

$tituloReporte = "Reporte Entrega";
...
header('Content-Disposition: attachment; filename="ReporteEntrega.xlsx"');
