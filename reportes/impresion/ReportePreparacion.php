...
$objPHPExcel->getProperties()->setCreator("MicrosipWeb") //Autor
    ...
    ->setTitle("Reporte Preparacion")
    ->setSubject("Reporte Excel")
    ->setDescription("Reporte de Preparacion")
    ->setKeywords("reporte de Preparacion")
    ->setCategory("Reporte MicrosipWeb");

$tituloReporte = "Reporte Preparacion";
...
header('Content-Disposition: attachment; filename="ReportePreparacion.xlsx"');
