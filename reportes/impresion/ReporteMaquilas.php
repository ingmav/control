...
$objPHPExcel->getProperties()->setCreator("MicrosipWeb") //Autor
    ...
    ->setTitle("Reporte Maquilas")
    ->setSubject("Reporte Excel")
    ->setDescription("Reporte de Maquilas")
    ->setKeywords("reporte de Maquilas")
    ->setCategory("Reporte MicrosipWeb");

$tituloReporte = "Reporte Maquilas";
...
header('Content-Disposition: attachment; filename="ReporteMaquilas.xlsx"');
