...
require('../../dompdf/dompdf_config.inc.php');
    ...
    $table.= "<tr style='border:1px solid #DEDEDE; background:#CCC'><td  width='60px'>CLIENTE</td><td  width='150px'>CLASE / SEGMENTO</td><td  width='230px'>CONTACTO</td><td  width='30px'>TELEFONO</td><td>CORREO</td><td>ESTATUS</td></tr>";
