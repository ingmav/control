...
$objPHPExcel->getProperties()->setCreator("MicrosipWeb") //Autor
    ...
    ->setDescription("Reporte de Ventas Anual")
    ->setKeywords("reporte de ventas anual")
    ->setCategory("Reporte MicrosipWeb");

$tituloReporte = "Reporte Ventas Anual";
...
header('Content-Disposition: attachment; filename="ReporteVentasAnual.xlsx"');
