...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="cuerpo">
        	<div id="page-wrapper">
            	<div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-apple"></i> Procesos de Diseño</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
            	<div class="row">
                	<div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Procesos
                                 ...
                                 <button type="button" class="btn btn-default" onclick="window.open('reportes/impresion/ReporteDiseno.php?tipo=2','_blank')"><span class='fa fa-print'></span></button>
    ...
    <script src="js/Modulos/diseno/scripts.js"></script>
