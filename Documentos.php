                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <div class="btn-group pull-right">
                                   ...
                                   <button type="button" class="btn btn-danger" onclick="eliminarFolios()"><span class='fa fa-close'></span></button>  
                                </div>
                            </div>
                            <!-- /.panel-heading -->
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <ul class="nav nav-pills">
                                                        <!--<li class="active" id="nexos"><a href="#home-pills" data-toggle="tab">Nexos Empresariales</a></li>-->
                                                        <li id="nexprint"><a href="#home-pills" data-toggle="tab">Nexprint</a></li> 
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" aria-describedby="dataTables-example_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <!--<th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 186px;">IMPORTE</th>-->
                                                <th style="width: 50px;">
                                                    ACTIVIDADES
                                                </th>
                                                <th></th>
        ...
        <div class="modal-dialog modal-dialog-fullscreen">
            <div class="modal-content modal-content-fullscreen">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" id='CerrarProduccion'>Cerrar Sin ingresar a Producción</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
